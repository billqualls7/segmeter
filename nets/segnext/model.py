...
Date: 2025-04-03 11:29:41
LastEditors: wy 1955416359@qq.com
LastEditTime: 2025-04-07 19:59:42
FilePath: /seg2025/segformer/nets/segnext/model.py
Description: 

'''
#%%
import yaml, math, os
with open('/data_jiang/wy/code/seg2025/segformer/nets/segnext/config.yaml') as fh:
...
pretrained_weights = torch.load("/data_jiang/wy/code/seg2025/segformer/nets/segnext/mscan_t.pth")
